...
svm.out$Predicted <- predict(svm.locomotion.tuned, test.df[, -c(1:4, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(svm.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Statistical/Locomotion_SVM.csv", row.names = F)
...
decisionTree.out$Predicted <- predict(decisionTree.locomotion.tuned, test.df[, -c(1:4, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(decisionTree.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Statistical/Locomotion_decisionTree.csv", row.names = F)
...
randomForest.out$Predicted <- predict(randomForest.locomotion.tuned, test.df[, -c(1:4, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(randomForest.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Statistical/Locomotion_randomForest.csv", row.names = F)
