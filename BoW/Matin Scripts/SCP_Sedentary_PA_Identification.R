...
svm.out$Predicted <- predict(svm.sedentary.tuned, test.df[, -c(1:2, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(svm.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Bag of Words/Matin/Sedentary_SVM.csv", row.names = F)
...
decisionTree.out$Predicted <- predict(decisionTree.sedentary.tuned, test.df[, -c(1:2, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(decisionTree.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Bag of Words/Matin/Sedentary_decisionTree.csv", row.names = F)
...
randomForest.out$Predicted <- predict(randomForest.sedentary.tuned, test.df[, -c(1:2, ncol(test.df))])

# saving the output on test set for future analysis.
write.csv(randomForest.out, "~/Dropbox/Work-Research/Current Directory/Activity Recognition - Comparative Study/Data/Outputs/Bag of Words/Matin/Sedentary_randomForest.csv", row.names = F)
