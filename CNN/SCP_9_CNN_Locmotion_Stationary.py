...
#Script Name : SCP_9_CNN_Locmotion_Stationary.py

#Script Summary : 
#   This script used for classifying the data processed after the file SCP_2_Locmotion_Stationary.py is executed
