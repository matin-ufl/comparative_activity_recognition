...
#Script Name : SCP_2_Locmotion_Stationary.py

#Script Summary : 
#       This script first divides data into locmotion and stationary and then generates 10 second segments of all the time series data and stores it as a numpy ndarray.
...
Data1_df =  FUN_ConvertToLocomotion(Data1_df)
Data2_df =  FUN_ConvertToLocomotion(Data2_df)    
