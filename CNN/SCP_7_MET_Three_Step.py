...
#Script Name : SCP_7_MET_Three_Step.py
...
Segments_Train, mets_train , _ = FUN_Segment_ThreeStep(Data1_df,WindowSize)
Segments_Test, mets_test , _ = FUN_Segment_ThreeStep(Data2_df,WindowSize)
