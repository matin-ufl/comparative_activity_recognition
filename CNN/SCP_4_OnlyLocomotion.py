...
#Script Name : SCP_4_OnlyLocmotion.py

#Script Summary : 
#       This script takes in only Locmotion activites and then generates 10 second segments of all the time series data and stores it as a numpy ndarray.
...
Data1_df =  FUN_OnlyLocmotion(Data1_df)
Data2_df =  FUN_OnlyLocmotion(Data2_df)    
