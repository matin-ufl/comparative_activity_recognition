...
#Script Name : SCP_3_OnlySedentary.py

#Script Summary : 
#       This script takes in only Sedentary activites and then generates 10 second segments of all the time series data and stores it as a numpy ndarray.
...
Data1_df =  FUN_OnlySedentary(Data1_df)
Data2_df =  FUN_OnlySedentary(Data2_df)    
