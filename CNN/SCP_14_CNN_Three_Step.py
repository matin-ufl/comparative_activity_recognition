...
#Script Name : SCP_14_CNN_Three_Step.py

#Script Summary : 
#   This script is used to for MET value estimation using a three step approach
...
#The Model
model = Sequential()
model.add(Conv2D(20,(1,10),activation='relu',input_shape=(1,100,12)))
